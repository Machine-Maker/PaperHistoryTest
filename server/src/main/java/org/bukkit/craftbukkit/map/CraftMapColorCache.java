...
public class CraftMapColorCache implements MapPalette.MapColorCache {
    ...
    public CompletableFuture<Void> initCache() {
        Preconditions.checkState(!this.cached && !this.running, "Cache is already build or is currently being build");
    ...
    public boolean isCached() {
        return this.cached || (!this.running && this.initCache().isDone());
    }
